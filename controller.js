...
function switchToDebugMode() {
    ...
    if ([Mode.PLAY_MODE, Mode.DEBUG_MODE, Mode.INPUT_MODE].includes(mode)) {
...
document.querySelector("#iobox").addEventListener("focus", () => {
    iobox.querySelector("#iobox-cursor").removeAttribute("hidden");
});
document.querySelector("#iobox").addEventListener("blur", () => {
